 ...
 */
package org.bttc.relayer.burnproof.mpt;
...
class ExtensionNode<V> implements Node<V> {
  ...
  public Bytes32 getHash() {
    ...
    String rlpStr = getRlp().toString();
    String hashStr = Hash.sha3(rlpStr);
    Bytes32 hashed = Bytes32.fromHexString(hashStr);
  ...
  public String print() {
    ...
    final String childRep = getChild().print().replace("\n\t", "\n\t\t");
    builder
        .append("Extension:")
        .append("\n\tRef: ")
        .append(getRlpRef())
